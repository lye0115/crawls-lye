    ...
    var d = {},
      ...
      q = (l.BufferedBlockAlgorithm = t.extend({
        ...
        nc7V: function (a) {
          ...
          j = u.min(4 * a, j);
          if (a) {
            for (var q = 0; q < a; q += k) this.sS8K(e, q);
            q = e.splice(0, a);
            c.sigBytes -= j;
          }
    ...
    d.BlockCipher = v.extend({
      ...
      reset: function () {
        ...
        var a = this.cfg,
          b = a.iv,
          a = a.mode;
        if (this.Qt5y == this.Hy4C) var c = a.createEncryptor;
        else (c = a.createDecryptor), (this.Qk5p = 1);
...
function getSign(d, e, f, g) {
  ...
  var g = "0CoJUm6Qyw8W8jud";
  return asrsea(d, e, f, g);
}

// 方法返回值
// {encText: string,encSecKey: string}
